...
const intList = [43, 127, 89, 12, 65, 34, 78, 92];
// const intList = [
...
function Sorting() {
  ...
  const [dataList, setDataList] = useState([...intList]);
  ...
  return (
    <div>
      ...
      <div className="flex justify-center gap-2">
        <Button onClick={handleOnStart} disabled={!selectedAlgo || isStart}>
          Start
        </Button>
